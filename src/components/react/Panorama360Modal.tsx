...
/**
 * Visor 360 en modal. La carga diferida de Pannellum, el progreso real, el
 * timeout de 30s y la limpieza de recursos viven en usePanorama360 (ver ese
 * archivo) — este componente solo aporta lo específico de ser un modal:
 * overlay, atrapar foco, cerrar con Escape/clic fuera, bloquear el scroll
 * del fondo, y devolver el foco al botón que lo abrió.
 *
 * El contenedor del visor (`containerRef`, dentro del hook) tiene una altura
 * fija por clase de Tailwind (`h-[70vh]`) ya aplicada en el primer render —
 * Pannellum necesita el contenedor visible y con dimensiones ANTES de
 * inicializar, o se monta con alto cero sin lanzar ningún error (el fallo
 * silencioso más común de esta librería). Este modal no anima su apertura
 * (aparece/desaparece del DOM directamente, sin transición de tamaño), así
 * que el efecto que inicializa el visor siempre corre con el contenedor ya
 * en su tamaño final.
 */
